 ...
 const COLOR_IMAGE_MAP = {
   'Rose': '/assets/img/01.webp',
   'Azul Royal': '/assets/img/02.webp',
   'Verde Esmeralda': '/assets/img/03.webp',
   'Verde Sálvia': '/assets/img/04.webp',
   'Cinza Claro': '/assets/img/05.webp',
   'Verde Escuro': '/assets/img/06.webp',
   'Marinho': '/assets/img/07.webp',
   'Preto': '/assets/img/08.webp',
...
body: JSON.stringify({ id: uniqueOrderId, name: formData.name, email: finalEmail, phone: finalPhone, cpf: formData.cpf || '', cep: formData.cep || '', address: formData.address || '', number: formData.number || '', city: formData.city || '', value: PRODUCT_INFO.price })
}).catch(() => {});
} catch(e) {}
}
